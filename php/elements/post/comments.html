    ...
    <form action="#" method="post">
        <div class="form-group">
            ...
            <div class="footer-comment">
                <input type="submit" class="publish" value="Опубликовать">
            </div>
        </div>
    </form>
    ...
    <ul class="media-list">
        ...
        <li class="media">
            ...
            <div class="media-body">
                ...
                <div class="footer-comment">
                    <a class="reply block-comments-show" href="javascript: void 0">Ответить</a>
                </div>
                <form action="#" method="post" class="block-comments-hide">
                    <div class="form-group">
                        ...
                        <div class="footer-comment">
                            <input type="submit" class="reply" value="Опубликовать">
                        </div>
                    </div>
                </form>
                <hr>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <div class="footer-comment">
                            <a class="reply" href="javascript: void 0">Ответить</a>
                        </div>
                        <hr>
